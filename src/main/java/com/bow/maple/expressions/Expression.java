 ...
 * represented in SQL commands. Expressions can contain literal values, symbolic
 * references (e.g. to columns on tables), arithmetic and logical operators, SQL
 * operators such as <tt>LIKE</tt> and <tt>IN</tt>, and so forth.
 * <p>
...
public abstract class Expression implements Cloneable {
    ...
    /**
     * Returns a {@link ColumnInfo} object describing the type (and possibly the
     * name) of the expression's result.
     *
    ...
    /**
     * Evaluates this expression object without any environment. This method may
     * only be used if the expression doesn't contain any symbolic values. If
     * the expression does contain symbols then an exception will be thrown at
     * evaluation time.
     *
     * @return the result of the expression evaluation
     *
     ...
     * symbol-reference</em> can pass in a {@link java.util.List}
     * implementation, while callers that only need to know what symbols are
     * referenced could pass a {@link java.util.Set} implementation as the
     * argument.
     *
     ...
     * then the return-value will simply be this expression object,
     * unsimplified.
     *
