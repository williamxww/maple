...
public class TypeConverter {
    ...
    public static Short getShortValue(Object obj) {
        ...
        if (obj instanceof Short) {
            ...
            throw new TypeCastException("Cannot convert type \"" +
                (obj != null ? obj.getClass() : "null") + "\" to short.");
        }
    ...
    public static Integer getIntegerValue(Object obj) {
        ...
        if (obj instanceof Integer) {
            ...
            throw new TypeCastException("Cannot convert type \"" +
                (obj != null ? obj.getClass() : "null") + "\" to integer.");
        }
    ...
    public static Long getLongValue(Object obj) {
        ...
        if (obj instanceof Long) {
            ...
            throw new TypeCastException("Cannot convert type \"" +
                (obj != null ? obj.getClass() : "null") + "\" to long.");
        }
    ...
    public static Float getFloatValue(Object obj) {
        ...
        if (obj instanceof Float) {
            ...
            throw new TypeCastException("Cannot convert type \"" +
                (obj != null ? obj.getClass() : "null") + "\" to float.");
        }
    ...
    public static Double getDoubleValue(Object obj) {
        ...
        if (obj instanceof Double) {
            ...
            throw new TypeCastException("Cannot convert type \"" +
                (obj != null ? obj.getClass() : "null") + "\" to double.");
        }
