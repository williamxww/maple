...
public class SortNode extends PlanNode {
    ...
    public SortNode(PlanNode subplan, List<OrderByExpression> orderByExprs) {
        ...
        if (orderByExprs.isEmpty()) {
            throw new IllegalArgumentException("orderByExprs must include at least one expression");
        }
...
//    }
    ...
    public void prepare() {
        ...
        if (childCost != null) {
            ...
            logger.info("Child's cost not available; not computing this node's cost.");
        }
     ...
     *
     * @throws java.io.IOException if table data cannot be read from the
     *         filesystem
...
//    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SortNode) {
            ...
            return orderByExprs.equals(other.orderByExprs) && leftChild.equals(other.leftChild);
        }
        return false;
    }
