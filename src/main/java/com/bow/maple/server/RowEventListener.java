...
public interface RowEventListener {
     ...
     */
    void beforeRowInserted(TableFileInfo tblFileInfo, Tuple newValues)
     ...
     */
    void afterRowInserted(TableFileInfo tblFileInfo, Tuple newTuple)
        throws EventDispatchException;
     ...
     */
    void beforeRowUpdated(TableFileInfo tblFileInfo, Tuple oldTuple,
                          Tuple newValues) throws EventDispatchException;
     ...
     */
    void afterRowUpdated(TableFileInfo tblFileInfo, Tuple oldValues,
     ...
     */
    void beforeRowDeleted(TableFileInfo tblFileInfo, Tuple oldTuple)
        throws EventDispatchException;
     ...
     *                  deleted.
     */
    void afterRowDeleted(TableFileInfo tblFileInfo, Tuple oldValues)
        throws EventDispatchException;
}
