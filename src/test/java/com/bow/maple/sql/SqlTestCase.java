...
public class SqlTestCase {
    ...
    public static final String TEST_SQL_PROPS = "com/bow/maple/sql/test_sql.props";
    ...
    public void beforeClass() throws Exception {
        ...
        System.setProperty(StorageManager.PROP_BASEDIR, testBaseDir.getAbsolutePath());
        ...
        if (setupSQLPropName != null) {
            ...
            if (setupSQL == null) {
                throw new IOException("Property " + setupSQLPropName + " not specified in " + TEST_SQL_PROPS);
            }
    ...
    private void loadTestSQLProperties() throws IOException {
        InputStream is = getClass().getClassLoader().getResourceAsStream(TEST_SQL_PROPS);
        if (is == null)
    ...
    public void afterClass() {
        // Shut down the database server and clean up the testing
        // base-directory.
