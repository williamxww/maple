...
public class DBPageTest extends StorageTestCase {
    ...
    /**
     * Test readBoolean() and writeBoolean() methods in DBPage<br/>
      * |0xCC|true|0xAA|
     */
    @Test
    public void testReadWriteBoolean() {
        ...
        dbPage.writeByte(0, canary1);
        // write Boolean value at position 1
        dbPage.writeBoolean(1, true);
        dbPage.writeByte(2, canary2);


        assert dbPage.readBoolean(1);
        assert (dbPage.readByte(0) == (byte) canary1);
        assert (dbPage.readByte(2) == (byte) canary2);
    }

    /**
     * Test readShort(), readUnsignedShort(), and writeShort() methods in
     * DBPage.
     */
    @Test
    ...
    /**
     * Test readInt(), readUnsignedInt(), and writeInt() methods in DBPage.
     */
    @Test
    ...
    /**
     * Test readFixedSizeString() and writeFixedSizeString() methods in DBPage.
     */
    @Test
    ...
    /**
     * Test readVarString255() and writeVarString255() methods in DBPage.
     */
    @Test
    public void testReadWriteVarString255() {
        ...
        value = "A SURGE in the radiation levels surrounding the "
                ...
                + "from the site of Japan's escalating nuclear catastrophe. " + "A skeleton crew of 50, these are";
    ...
    /**
     * Test readVarString65535() and writeVarString65535() methods in DBPage.
     */
    @Test
    public void testReadWriteVarString65535() {
        ...
        assert value.length() == 8188 : "test string length is not 8188 (it's " + value.length() + ")";
